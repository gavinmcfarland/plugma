...
// Create Command - handled by shell-out in bin/plugma.js
...
program.hook('preAction', async (thisCommand, actionCommand) => {
	...
	// Skip prompt for create and add commands (handled by shell-out)
...
// Add Command - handled by shell-out in bin/plugma.js
