...
import type { PlugmaRuntimeData, WindowSettings } from '../../shared/types'
...
export async function handleSaveWindowSettings(msg: SaveWindowSettingsMessage): Promise<void> {
...
handleSaveWindowSettings.EVENT_NAME = 'PLUGMA_SAVE_PLUGIN_WINDOW_SETTINGS' as const
