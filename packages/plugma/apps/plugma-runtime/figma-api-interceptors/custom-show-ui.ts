import type { PlugmaRuntimeData, ShowUIOptions } from '../../shared/types'
import { getCommandHistory } from '../utils/get-command-history'
import { DEFAULT_WINDOW_SETTINGS, getWindowSettings } from '../utils/get-window-settings'
 ...
 */
export function customShowUI(htmlString: string, initialOptions?: ShowUIOptions): void {
