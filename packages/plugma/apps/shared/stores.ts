...
// @ts-ignore
import { createClient } from '../../src/core/websockets/client'
...
export const isFigmaConnected = writable(false)
...
export const isTestRunnerConnected = writable<boolean>(false)
