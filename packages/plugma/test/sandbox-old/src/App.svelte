	...
	onMount(() => {
		...
		for (const icon of icons) {
			icon.addEventListener('dragend', (e) => {
				...
				// console.log(icon, e, file, parentingStrategy)
...
<!-- <div class="icons-grid">
	<span class="icon" draggable="true">
		<svg
			...
			class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg
		>
	</span>
	...
	<span class="icon" draggable="true">
		<svg
			...
			><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon
	...
	<span class="icon" draggable="true">
		<svg
			...
			><line x1="18" y1="10" x2="6" y2="10"></line><line x1="21" y1="6" x2="3" y2="6"></line><line
				x1="21"
				y1="14"
				x2="3"
				y2="14"
			></line><line x1="18" y1="18" x2="6" y2="18"></line></svg
		>
	</span>
	...
	<span class="icon" draggable="true">
		<svg
			...
			><circle cx="12" cy="5" r="3"></circle><line x1="12" y1="22" x2="12" y2="8"></line><path
	...
	<span class="icon" draggable="true">
		<svg
			...
			><circle cx="12" cy="12" r="10"></circle><polyline points="12 8 8 12 12 16"></polyline><line
				x1="16"
				y1="12"
				x2="8"
				y2="12"
	...
	<span class="icon" draggable="true">
		<svg
			...
			><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line
				x1="6"
				y1="20"
				x2="6"
				y2="16"
	...
	<span class="icon" draggable="true">
		<svg
			...
			><polyline points="6.5 6.5 17.5 17.5 12 23 12 1 17.5 6.5 6.5 17.5"></polyline></svg
		>
	</span>
</div>
